...
(library Library_1
	...
	(patternDef "SODFL5226X110N" (originalName "SODFL5226X110N")
		...
		(layerContents (layerNumRef 28)
			(line (pt -2.138 1.3) (pt 2.138 1.3) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 2.138 1.3) (pt 2.138 -1.3) (width 0.025))
		)
		...
		(layerContents (layerNumRef 28)
			(line (pt -2.138 0.39) (pt -1.228 1.3) (width 0.025))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "SBRT5A50SAF-13" (originalName "SBRT5A50SAF-13") (compHeader (numPins 2) (numParts 1) (refDesPrefix D)
		...
		(attr "<Hyperlink>" "https://www.diodes.com/assets/Datasheets/SBRT5A50SAF.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "SBRT5A50SAF-13.stp")
