...
(library Library_1
	...
	(compDef "LM5013QDDARQ1" (originalName "LM5013QDDARQ1") (compHeader (numPins 9) (numParts 1) (refDesPrefix IC)
		...
		(compPin "4" (pinName "RON") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "6" (pinName "PGOOD") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.ti.com/lit/ds/symlink/lm5013-q1.pdf?ts=1650857966126&ref_url=https%253A%252F%252Fwww.ti.com%252Fproduct%252FLM5013-Q1%253FkeyMatch%253DLM5013QDDARQ1%2526tisearch%253Dsearch-everything%2526usecase%253DOPN")
		(attr "<Component Height>" "1.7")
		(attr "<STEP Filename>" "LM5013QDDARQ1.stp")
